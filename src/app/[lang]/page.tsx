...
export default async function BaseHome({ params }: { params: { lang: keyof typeof languages } }) {
    ...
    <main role="document" className="print:max-w-none print:w-unset w-[870px] max-w-full px-3 md:px-8 mx-auto">
      <div className="flex justify-between items-center mx-3 md:mx-8">
        ...
        <div className="grow pl-4">
          ...
          <h2 className="text-xl md:text-2xl print:text-2xl text-emerald-600">{lang.general.workTitle}</h2>
        </div>
      </div>
      <div className="mx-3 md:mx-8">
      </div>
      {lang.presentation.role.map(str => (
        <p key={str} className="my-4 mx-3 md:mx-8">{str}</p>
      ))}
      ...
      <div className="grid gap-4 md:grid-cols-5 justify-between">
        <div className="md:col-span-3">
          <h3 className="text-2xl font-bold uppercase pl-8 pb-1 mb-2 border-b-2 border-emerald-600">{lang.work.title}</h3>
        ...
        <div className="md:col-span-2">
          <h3 className="text-2xl font-bold uppercase pl-8 pb-1 mb-2 border-b-2 border-emerald-600">{lang.skills.title}</h3>
          ...
          <h3 className="text-2xl font-bold uppercase pl-8 pb-1 mt-4 mb-2 border-b-2 border-emerald-600">{lang.skills.languages.title}</h3>
          <ul className="mx-3 md:mx-8">
          ...
          <h3 className="text-2xl font-bold uppercase pl-8 pb-1 mt-4 mb-2 border-b-2 border-emerald-600">{lang.certificates.title}</h3>
          <ul className="mx-3 md:mx-8">
          ...
          <h3 className="text-2xl font-bold uppercase pl-8 pb-1 mt-4 mb-2 border-b-2 border-emerald-600">{lang.education.title}</h3>
          <div className="mx-3 md:mx-8">
          ...
          <h3 className="text-2xl font-bold uppercase pl-8 pb-1 mt-4 mb-2 border-b-2 border-emerald-600">{lang.general.references.title}</h3>
